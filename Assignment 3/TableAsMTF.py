...
class Table:
    ...
    def lookup(self, key):
        """
            Syfte: Ser efter om tabellen innehåller nyckeln key och flyttar i så fall
                   fram nyckeln till början av tabellen, och returnerar värdet 
                   som är kopplat till nyckeln
